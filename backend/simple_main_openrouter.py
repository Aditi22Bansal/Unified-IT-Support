...
async def get_openrouter_response(message: str) -> str:
...
async def chat_with_bot(chat_data: dict):
    """Chat with the AI-powered universal assistant using OpenRouter."""
    ...
    response_text = await get_openrouter_response(message)
